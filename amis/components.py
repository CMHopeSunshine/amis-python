...
class Form(AmisNode):
    ...
    horizontal: Horizontal = {"left": 2, "right": 10, "justify": False}
...
class TableView(AmisNode):
    ...
    class Trs(AmisNode):
        ...
        background: str = None
        """行背景色"""
        tds: List[Tds, dict] = None

    type: str = 'table-view'
    """指定为 table-view 渲染器"""
    trs: List[dict, Trs] = None
    """行配置"""
...
class Calendar(AmisNode):
    ...
    type: str = 'calendar'
    """指定为 calender 渲染器"""
    schedules: List[dict, Schedules] = None
